...
<section id="content">
	<h2>Hello Spring</h2>
	<h3>ajax통신하기</h3>
	<h4><button type="button" class="btn btn-outline-primary" onclick="basicAjax();">기본ajax처리</button></h4>
	<h4><button type="button" class="btn btn-outline-success" onclick="convertAjax();">json받기</button></h4>
